...
I want to make lightweight danmaku game (Touhou style). Now I made a simple game where you can walk and jump... but then I going to add more functions! I use only SDL2!
